...
const Page = (slugs: any) => {
    ...
    const {data, error, isLoading} = useFetch<Vendor>(`vendor/${slugs.params.id}`)
            ...
            <div className="flex items-center flex-col max-w-7xl mx-auto">
                ...
                <div className="flex justify-between w-full">
                    ...
                    {isModalOpen && (
                        ...
                        >
                            <div className={'overflow-auto h-[calc(100vh_-_10rem)] space-y-4 py-6 px-1.5 md:px-6 lg:px-10 snap-both snap-mandatory scroll-smooth'}>
                                <AddProduct/>
                            </div>
                        </Modal>
                    )}

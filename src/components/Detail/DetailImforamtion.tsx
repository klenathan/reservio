...
const DetailInformation: React.FC<DetailInformationProps> = ({name, avatarUrl, description, vendorName}) => {
    ...
    return (
        <div className="flex flex-col md:items-start md:justify-start space-y-7 ">
            ...
            <div className="flex flex-row w-full border-b-2 border-gray-300 pb-2">
                <h2 className="text-gray-800 font-bold text-xl md:text-2xl md:ml-0 m-auto">{name}</h2>

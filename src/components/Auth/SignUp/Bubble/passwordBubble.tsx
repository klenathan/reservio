...
const PasswordBubbleWrap: React.FC<PasswordBubbleWrapProps> = (
  props: PasswordBubbleWrapProps
) => {
  return (
    <div className="absolute top-full left-0 rounded-lg shadow-lg p-4 w-full bg-gray-100">
      ...
      <ul className="list-disc list-inside leading-7">
        <li
          className={`${
            props.hasLength ? "text-green-500" : "text-red-500"
        ...
        <li
          className={`${
            props.hasLowercase ? "text-green-500" : "text-red-500"
          } text-sm md:text-base`}
        >
        ...
        <li
          className={`${
            props.hasUppercase ? "text-green-500" : "text-red-500"
          } text-sm md:text-base`}
        >
        ...
        <li
          className={`${
            props.hasDigit ? "text-green-500" : "text-red-500"
          } text-sm md:text-base`}
        >
